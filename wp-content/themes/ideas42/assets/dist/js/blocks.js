...
var _wp$components = wp.components,
    ...
    PanelBody = _wp$components.PanelBody; // Register the block
...
registerBlockType("nclud/container", {
  ...
  edit: function edit(props) {
    ...
    var isSelected = props.isSelected,
        spacer = props.attributes.spacer,
        setAttributes = props.setAttributes;
    blockProps.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(blockProps.className, "container", spacer);

    var handleSpacer = function handleSpacer(value) {
      setAttributes({
        spacer: value
      });
      blockProps.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(blockProps.className, "container", spacer);
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(Fragment, {
      children: [isSelected && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(InspectorControls, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(PanelBody, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(ToggleGroupControl, {
            label: "Space size",
            onChange: handleSpacer,
            value: spacer,
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ToggleGroupControlOption, {
              label: "XS",
              value: "spacer-xs"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ToggleGroupControlOption, {
              label: "S",
              value: "spacer-sm"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ToggleGroupControlOption, {
              label: "M",
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", _objectSpread(_objectSpread({}, blockProps), {}, {
  ...
  save: function save(_ref) {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("section", _objectSpread(_objectSpread({}, blockProps), {}, {
...
/***/ "./assets/js/blocks/fontFamily.jsx":
/*!*****************************************!*\
  !*** ./assets/js/blocks/fontFamily.jsx ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "FontFamilyBlockEdit": () => (/* binding */ FontFamilyBlockEdit),
/* harmony export */   "addFontFamilyAttrs": () => (/* binding */ addFontFamilyAttrs),
/* harmony export */   "addFontFamilyClass": () => (/* binding */ addFontFamilyClass),
/* harmony export */   "applyFontFamilyClass": () => (/* binding */ applyFontFamilyClass)
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
var _wp$components = wp.components,
    ...
    SelectControl = _wp$components.SelectControl; //restrict to specific block names
...
var addFontFamilyAttrs = function addFontFamilyAttrs(settings) {
  if (typeof settings.attributes.fontFamily !== 'undefined' && allowedBlocks.includes(settings.name)) {
...
var applyFontFamilyClass = function applyFontFamilyClass(props, blockType, attributes) {
  if (!allowedBlocks.includes(blockType.name)) {
    return props;
  }

  var fontFamily = attributes.fontFamily;
  props.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(props.className, fontFamily);
};

var addFontFamilyClass = function addFontFamilyClass(props) {
  var fontFamily = props.attributes.fontFamily,
      className = props.className,
      name = props.name;

  if (allowedBlocks.includes(name)) {
    props.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, fontFamily);
  }
};
/**
...
var FontFamilyBlockEdit = function FontFamilyBlockEdit(props) {
  var name = props.name,
      attributes = props.attributes,
      setAttributes = props.setAttributes,
      isSelected = props.isSelected;
  var fontFamily = attributes.fontFamily;
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Fragment, {
    children: isSelected && allowedBlocks.includes(name) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(PanelBody, {
        title: "Font Family",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LayoutBlockEdit": () => (/* binding */ LayoutBlockEdit),
/* harmony export */   "addLayoutClass": () => (/* binding */ addLayoutClass),
/* harmony export */   "addLayouts": () => (/* binding */ addLayouts),
/* harmony export */   "applyLayoutsStyles": () => (/* binding */ applyLayoutsStyles)
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
var _wp$components = wp.components,
    ...
    ToolsPanel = _wp$components.__experimentalToolsPanel,
    ToolsPanelItem = _wp$components.__experimentalToolsPanelItem,
...
var applyLayoutsStyles = function applyLayoutsStyles(props, blockType, attributes) {
  if (!allowedBlocks.includes(blockType.name)) {
    return props;
  }
  ...
  props.style = props.style = _objectSpread(_objectSpread({}, props.style), {
    width: width,
    height: height,
    maxWidth: maxWidth,
    rowGap: rowGap,
...
var LayoutBlockEdit = function LayoutBlockEdit(props) {
  var name = props.name,
      attributes = props.attributes,
      setAttributes = props.setAttributes,
      isSelected = props.isSelected;
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Fragment, {
    children: isSelected && allowedBlocks.includes(name) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Panel, {
        title: "Font Family",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(ToolsPanel, {
          label: "Layout Size",
          resetAll: resetAll,
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ToolsPanelItem, {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(UnitControl, {
              label: "Width",
              value: width,
          ...
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ToolsPanelItem, {
            hasValue: function hasValue() {
              return !!height;
            },
            label: "Height",
...
registerBlockType("nclud/spacer", {
  ...
  edit: function edit(props) {
    ...
    var isSelected = props.isSelected,
        spacer = props.attributes.spacer,
        setAttributes = props.setAttributes;
    blockProps.className = classnames__WEBPACK_IMPORTED_MODULE_0___default()(blockProps.className, spacer);
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(Fragment, {
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("section", _objectSpread({}, blockProps))]
    });
  },
  save: function save(_ref) {
    var attributes = _ref.attributes;
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("section", _objectSpread({}, blockProps));
  }
});
